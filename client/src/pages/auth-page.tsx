      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary to-primary-400 text-white flex-col justify-center p-12">
        <div className="max-w-lg mx-auto">
          ...
          <p className="text-xl mb-8">
            The Optimal Platform for Patent Document Translation
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-white/80">
                  GPT-powered technology optimized for technical document
                  translation
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-white/80">
                  Store and utilize translation history to maintain consistent
                  translation quality
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold">Glossary Support</h3>
                <p className="text-white/80">
                  Maintain consistency of technical terms through patent
