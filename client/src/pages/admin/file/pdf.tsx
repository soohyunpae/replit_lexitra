...
export default function PDFProcessingPage({ embedded = false }: PDFProcessingProps) {
  ...
  // The PDF processing card content
  ...
  // If embedded in another component, render just the card
  if (embedded) {
    return <ProcessingCard />
  }

  // Otherwise, wrap with MainLayout and include the header
  return (
